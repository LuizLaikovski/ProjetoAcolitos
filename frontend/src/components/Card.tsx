        ...
        <>
            <div key={id} className="box h-auto w-full sm:w-[25dvw] md:w-[30dvw] lg:w-[25dvw] rounded-lg p-5 shadow-2xl bg-white">
                ...
                <ul className="mt-4">
                    ...
                    <li className="m-3 text-[14px]"><FontAwesomeIcon icon={faLocationDot} size="2xl" className="mr-3" /> Comunidades: {(Array.isArray(comunidades) ? comunidades : [comunidades]).join(', ')}</li>
